...
# `pwsh -File <script> -UnityVersions a b c` binds ONLY `a` to -UnityVersions and leaves `b c` unbound, so a
...
# (`./scripts/unity/maintain-windows-runner.ps1 -UnityVersions a,b,c`) or a comma-separated list instead.
