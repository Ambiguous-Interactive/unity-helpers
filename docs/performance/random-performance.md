...
<table data-sortable>
  ...
  <tbody>
    ...
    <tr><td>RomuDuo</td><td align="right">702,200,000</td><td data-sort-value="4">Fast</td><td data-sort-value="3">Good</td><td>Published romuDuo: the ROMU multiplier with the ROTL(y,36) + ROTL(y,15) - x update. NextUint returns the low 32 bits of the 64-bit word. <a href="https://arxiv.org/abs/2002.11331">Overton 2020</a></td></tr>
