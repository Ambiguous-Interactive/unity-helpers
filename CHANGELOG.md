...
- Add a JesseSort adaptation with linear monotone-input handling, contiguous pile storage and adjacent pairwise pile merging, credited to Jesse Lew. See [JesseSort](./docs/performance/ilist-sorting-performance.md#jessesort) ([#747](https://github.com/Ambiguous-Interactive/unity-helpers/issues/747)).
