...
- Add **Tools > Wallstop Studios > Unity Helpers > Authored Assets**, reports for a type nothing can author, an unfilled `[WNotNull]` slot, a `SerializableDictionary` that lost its pairing, and a keyframe that resolves to nothing. Reading is never destructive. See [Authored Asset Validation](./docs/features/editor-tools/authored-asset-validation.md) ([#618](https://github.com/Ambiguous-Interactive/unity-helpers/issues/618), [#619](https://github.com/Ambiguous-Interactive/unity-helpers/issues/619), [#620](https://github.com/Ambiguous-Interactive/unity-helpers/issues/620), [#624](https://github.com/Ambiguous-Interactive/unity-helpers/issues/624), [#631](https://github.com/Ambiguous-Interactive/unity-helpers/issues/631)).
