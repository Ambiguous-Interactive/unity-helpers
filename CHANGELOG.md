...
- Add a time-sliced editor validation engine and CI report. Failed, cancelled and incomplete runs retain the last complete result. See [Asset Validation](./docs/features/editor-tools/asset-validation.md) ([#288](https://github.com/Ambiguous-Interactive/unity-helpers/issues/288), [#648](https://github.com/Ambiguous-Interactive/unity-helpers/issues/648)).
- Add the **Asset Validation** window -- **Tools > Wallstop Studios > Unity Helpers** -- a dockable results view with search, a severity floor, click-to-ping, and one-click suppression. A rule from a test assembly never runs, and a scan you asked for gets a foreground time slice ([#288](https://github.com/Ambiguous-Interactive/unity-helpers/issues/288), [#634](https://github.com/Ambiguous-Interactive/unity-helpers/issues/634)).
