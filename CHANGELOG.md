...
- Add **Report Stale Serialized Keys** and **Repair Stale Serialized Keys In Selection**, for keys an asset still records that no field claims. The repair rewrites one asset at a time and undoes any rewrite that comes back with fewer objects. See [Authored Asset Validation](./docs/features/editor-tools/authored-asset-validation.md#stale-serialized-keys) ([#617](https://github.com/Ambiguous-Interactive/unity-helpers/issues/617)).
