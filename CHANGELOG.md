...
- Add `WPROTO038`, which warns when a cache factory is passed as a method group -- C# rebuilds that delegate on every lookup, cache hits included. A warning at most, and switchable off. See [The generator](./docs/features/serialization/serialization.md#the-generator) ([#538](https://github.com/Ambiguous-Interactive/unity-helpers/issues/538)).
