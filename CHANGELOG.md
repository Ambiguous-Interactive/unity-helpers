...
- Bound how much a repeated WallstopProto field can allocate when a payload splits it across many runs. 30 KB of input asked for 200 MB ([#647](https://github.com/Ambiguous-Interactive/unity-helpers/issues/647)).
