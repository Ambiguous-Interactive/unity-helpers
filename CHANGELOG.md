...
- Add AOT protobuf support for `ValueTuple`: `Serializer.ProtoSerialize((7, 1.5f))` threw `ExecutionEngineException` on an IL2CPP player and now goes through a generated formatter. JSON of a raw tuple is still editor-only. See [SerializableValueTuple](./docs/features/serialization/serialization-types.md#serializablevaluetuple) ([#289](https://github.com/Ambiguous-Interactive/unity-helpers/issues/289)).
