...
namespace WallstopStudios.UnityHelpers.Tests.Serialization
{
    ...
    public sealed class WProtoRectangularArrayTests
    {
        ...
        public void AHeaderThatDisagreesWithItsElementsIsRefused(string payload, string why)
        {
            ...
            // bytes carrying it bounds what it asks for, and `[46341, 46341]` costs six bytes and
            // would ask for 8 GB. Requiring the product to equal the delivered count turns the claim
            // back into a number the sender already paid for, so every one of these is refused
            // rather than allocated, clamped, or silently zero-filled.
        ...
        public void AHeaderWhoseProductOverflowsIsRefusedRatherThanWrapped()
        {
            ...
            // eight-exabyte array. These sixteen bytes reached OutOfMemoryException before
            // WProtoRectangular.MultiplyDimensions saturated the product.
            WProtoReader reader = new WProtoReader(Parse("120E0A0C808080028080800180808001"));
